...
console.log(cases_list);
  const total_recovered = recovered_list[Math.floor(recovered_list.length/2)];
 // console.log(recovered_list);
  
 const new_recovered_cases = total_recovered - recovered_list[Math.floor(recovered_list.length/800)];
//const new_recovered_cases = total_recovered - Math.floor(total_recovered/826)];
